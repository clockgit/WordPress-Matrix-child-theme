...
if( strlen( $archive_tile_img_front ) ==0 ) { $archive_tile_img_front = wp_get_attachment_url( get_post_thumbnail_id($post->ID) ); }
if( strlen ($archive_tile_img_front ) ==0 ) { $archive_tile_img_front = matrix_first_image(); }
